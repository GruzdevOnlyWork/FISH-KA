...
// 🆕 SERVER ACTION (✅ 100% РАБОЧИЙ TypeScript)
export async function issueOrderItem(formData: FormData) {
  ...
  // 1. Получаем данные позиции + остаток товара
  ...
  // ✅ ИСПРАВЛЕНО: БЕЗОПАСНАЯ РАБОТА С product (массив → первый элемент)
  ...
  // 3. Помечаем позицию как выданную
  ...
  // 4. Если все позиции выданы → меняем статус заказа
